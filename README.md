...
- Const variables need value at the time of definition; `const name='TaiPham';`
...
- We can specify the type using `: Type` after the name of the variable, parameter or property, It is advisable to use `annotation method to specify data type while declaring the variable` (Example: let firstName: string = 'TaiPham')
...
- let personDetail: [string, number] = ['TaiPham', 35];
...
let person1 = new Greetings('TaiPham');
...
let greet1 = new Greetings('TaiPham');
